...
class Aspek_operasional extends CI_Controller {
    ...
    public function getdata_peserta_aktif_tahunan(){
       
        $data['data'] = $this->peserta_aktif_model->getdata('12');
       
		$data['bread'] = array('header'=>'Peserta Aktif ', 'subheader'=>'Semester');
		$data['view']  = "tahunan/peserta_aktif/data_peserta_aktif_tahunan";
		$this->load->view('main/utama', $data);
    }

    public function getdata_peserta_aktif_cabang_tahunan(){
        // $data['semester'] = getSemester();
        // var_dump( $data['semester'] );exit;
        $data['data'] = $this->aspek_operasional_model->get_peserta_aktif_cabang_semester(2);
		$data['bread'] = array('header'=>'Peserta Aktif Cabang', 'subheader'=>'Semester');
		$data['view']  = "tahunan/peserta_aktif/data_peserta_aktif_cabang_tahunan";
		$this->load->view('main/utama', $data);
    }
