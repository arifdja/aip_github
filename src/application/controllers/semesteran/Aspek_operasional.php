...
class Aspek_operasional extends CI_Controller {
    ...
    public function getdata_peserta_aktif_semester(){
        $data_peserta = [];
        $data6 = $this->peserta_aktif_model->getdata('6');
        $data12 = $this->peserta_aktif_model->getdata('12');
        ...
        foreach ($data_peserta as $k => $v) {
            if ($v['bulan']== '6') {
                $data_peserta[$k]['semester'] = '1';
            }
            if ($v['bulan']== '12') {
                $data_peserta[$k]['semester'] = '2';
            }

        }
        
        $data['semester'] = getSemester();
        $data['data'] = $data_peserta;
        // echo "<pre>";
