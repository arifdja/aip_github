<ul class="nav nav-tabs">
	<li role="presentation" <?php if($this->uri->segment(3)=="getdata_peserta_aktif_tahunan" || $this->uri->segment(2)=="getdata_peserta_aktif_tahunan"){echo 'class="active"';}?>><a href="<?php echo site_url('tahunan/aspek_operasional/getdata_peserta_aktif_tahunan');?>">Peserta Aktif</a></li>

	<li role="presentation" <?php if($this->uri->segment(3)=="getdata_peserta_aktif_cabang_tahunan" || $this->uri->segment(2)=="getdata_peserta_aktif_cabang_tahunan"){echo 'class="active"';}?>><a href="<?php echo site_url('tahunan/aspek_operasional/getdata_peserta_aktif_cabang_tahunan');?>">Peserta Aktif Cabang</a></li>
